...
import { askedFormsOf, assumedPlayable, firstLexeme, loreStateOf, readingByLexeme } from "../src/play/readings";
import { aForm, aLore, aReading, someInflection } from "./lore";
