...
describe("Plaques", () => {
    it("shows names, scores, the acting ring, and my marker", () => {
        ...
        const markup = renderToStaticMarkup(<Plaques view={view} company={company} mySeat={0} />);
    ...
    it("dims unclaimed seats as open", () => {
        ...
        const markup = renderToStaticMarkup(<Plaques view={aView()} company={company} mySeat={null} />);
    ...
    it("flags a queued premove", () => {
        ...
        const markup = renderToStaticMarkup(<Plaques view={view} company={aCompany()} mySeat={null} />);
