...
describe("Plaques", () => {
    it("shows names, scores, the acting ring, and my marker", () => {
        ...
        const markup = renderToStaticMarkup(
            <Plaques view={view} company={company} mySeat={0} countdown={null} clocked={false} />,
        );
    ...
    it("dims unclaimed seats as open", () => {
        ...
        const markup = renderToStaticMarkup(
            <Plaques view={aView()} company={company} mySeat={null} countdown={null} clocked={false} />,
        );
    ...
    it("flags a queued premove", () => {
        ...
        const markup = renderToStaticMarkup(
            <Plaques view={view} company={aCompany()} mySeat={null} countdown={null} clocked={false} />,
        );
    ...
    it("gives every plaque a clock line and counts down on the timed seat", () => {
        ...
        const markup = renderToStaticMarkup(
            <Plaques view={aView()} company={aCompany()} mySeat={null} countdown={countdown} clocked={true} />,
        );
    ...
    it("leaves the clock line out of an untimed table", () => {
        const markup = renderToStaticMarkup(
            <Plaques view={aView()} company={aCompany()} mySeat={null} countdown={null} clocked={false} />,
        );
