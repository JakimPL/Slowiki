...
import { GameOver } from "../src/table/GameOver";
import { aCompany, aView } from "./positions";
...
describe("GameOver", () => {
    it("ranks the standing and crowns the winner", () => {
        ...
        const markup = renderToStaticMarkup(<GameOver view={view} company={company} story={story} />);
