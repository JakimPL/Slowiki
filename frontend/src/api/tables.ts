...
export type TableTimeRequest = Schemas["TableTimeRequest"];
export type JoinRequest = Schemas["JoinRequest"];
export type TableDescription = Schemas["TableDescription"];
export type RuleParameters = Schemas["RuleParameters"];
