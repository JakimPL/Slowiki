...
export interface PlainValues {
    ...
    readonly "rules.confirm_delete": { readonly label: string };
    readonly "rules.confirm_heading": EmptyValues;
    readonly "rules.confirm_keep": EmptyValues;
    readonly "rules.confirm_revert": EmptyValues;
    ...
    readonly "rules.help.alphabet": EmptyValues;
    readonly "rules.help.bingo_bonus": EmptyValues;
    readonly "rules.help.bingo_tiles": EmptyValues;
    readonly "rules.help.blanks": EmptyValues;
    readonly "rules.help.board": EmptyValues;
    readonly "rules.help.dictionary": EmptyValues;
    readonly "rules.help.distribution": EmptyValues;
    readonly "rules.help.ending": EmptyValues;
    readonly "rules.help.exchange_limit": EmptyValues;
    readonly "rules.help.exchange_min_bag": EmptyValues;
    readonly "rules.help.going_out_award": EmptyValues;
    readonly "rules.help.going_out_bonus": EmptyValues;
    readonly "rules.help.increment_seconds": EmptyValues;
    readonly "rules.help.letters": EmptyValues;
    readonly "rules.help.opening_covers_center": EmptyValues;
    readonly "rules.help.opening_tiles": EmptyValues;
    readonly "rules.help.pass_allowed": EmptyValues;
    readonly "rules.help.pass_end_rounds": EmptyValues;
    readonly "rules.help.per_turn_seconds": EmptyValues;
    readonly "rules.help.premoves": EmptyValues;
    readonly "rules.help.rack_penalties": EmptyValues;
    readonly "rules.help.rack_size": EmptyValues;
    readonly "rules.help.scoreless_end_limit": EmptyValues;
    readonly "rules.help.seats": EmptyValues;
    readonly "rules.help.total_seconds": EmptyValues;
    readonly "rules.help.validate_on_play": EmptyValues;
    readonly "rules.help_label": EmptyValues;
    ...
    readonly "rules.letters_cancel": EmptyValues;
    readonly "rules.letters_close": EmptyValues;
    readonly "rules.letters_done": EmptyValues;
    readonly "rules.letters_heading": EmptyValues;
    readonly "rules.letters_shut": EmptyValues;
